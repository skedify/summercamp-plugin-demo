    ...
    <div className="bg-white">
      <header className="relative pb-24 bg-sky-800 sm:pb-32">
        ...
        <Popover as="div" className="relative z-10">
          ...
          >
            <div className="flex items-center justify-between w-full lg:w-auto">
              ...
              <div className="flex items-center -mr-2 lg:hidden">
                <Popover.Button className="inline-flex items-center justify-center p-2 bg-opacity-0 rounded-md bg-sky-800 text-cyan-100 hover:bg-opacity-100 focus:outline-none focus:ring-2 focus-ring-inset focus:ring-white">
            ...
            <div className="hidden lg:flex lg:items-center lg:space-x-6">
              <a
                href="#"
                className="px-6 py-2 text-base font-medium text-white bg-white border border-transparent rounded-md bg-opacity-10 hover:bg-opacity-20"
              >
                Login
              </a>
            </div>
          ...
          >
            <Popover.Panel focus className="absolute inset-x-0 top-0 p-2 transition origin-top transform lg:hidden">
              <div className="overflow-hidden bg-white rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                <div className="flex items-center justify-between px-5 pt-4">
                  ...
                  <div className="-mr-2">
                    <Popover.Button className="inline-flex items-center justify-center p-2 bg-white rounded-md text-warm-gray-400 hover:bg-warm-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-500">
                ...
                <div className="pt-5 pb-6">
                  <div className="px-2 space-y-1">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="block px-3 py-2 text-base font-medium rounded-md text-warm-gray-900 hover:bg-warm-gray-50"
                      >
                        {item.name}
                      </a>
                    ))}
                  ...
                  <div className="px-5 mt-6">
                    <a
                      href="#"
                      className="block w-full px-4 py-2 font-medium text-center text-white bg-green-400 border border-transparent rounded-md shadow hover:bg-green-500"
                    >
                      Login
                    </a>
                  </div>
        ...
        <div className="relative max-w-md px-4 mx-auto mt-24 sm:max-w-3xl sm:mt-32 sm:px-6 lg:max-w-7xl lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">Get in touch</h1>
          <p className="max-w-3xl mt-6 text-xl text-cyan-100">
      ...
      <main>
        ...
        <div className="bg-white">
          <div className="max-w-md px-4 py-8 mx-auto sm:max-w-3xl sm:py-8 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="divide-y divide-warm-gray-200">
              ...
              <section className="pt-16 mt-16 lg:grid lg:grid-cols-3 lg:gap-8" aria-labelledby="location-heading">
        ...
        <div className="relative">
          ...
          <div className="relative max-w-md px-4 mx-auto sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="px-6 py-10 bg-gradient-to-l from-sky-800 to-cyan-700 rounded-3xl sm:py-16 sm:px-12 lg:py-20 lg:px-20 lg:flex lg:items-center">
              ...
              <div className="mt-12 sm:w-full sm:max-w-md lg:mt-0 lg:ml-8 lg:flex-1">
                <form className="sm:flex">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="w-full px-5 py-3 border-white rounded-md placeholder-warm-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-cyan-700 focus:ring-white"
                    placeholder="Enter your email"
                  />
                  <button
                    type="submit"
                    className="flex items-center justify-center w-full px-5 py-3 mt-3 text-base font-medium text-white bg-green-400 border border-transparent rounded-md hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-cyan-700 focus:ring-green-400 sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0"
                  >
                    Notify me
                  </button>
                </form>
      ...
      <footer className="bg-white" aria-labelledby="footer-heading">
        ...
        <div className="max-w-md px-4 py-12 mx-auto sm:max-w-3xl sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="grid grid-cols-2 gap-8 mt-12 xl:mt-0 xl:col-span-2">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm font-semibold tracking-wider uppercase text-warm-gray-700">Solutions</h3>
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="text-sm font-semibold tracking-wider uppercase text-warm-gray-700">Support</h3>
                  <ul role="list" className="mt-4 space-y-4">
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-sm font-semibold tracking-wider uppercase text-warm-gray-700">Company</h3>
                  <ul role="list" className="mt-4 space-y-4">
                ...
                <div className="mt-12 md:mt-0">
                  <h3 className="text-sm font-semibold tracking-wider uppercase text-warm-gray-700">Legal</h3>
                  <ul role="list" className="mt-4 space-y-4">
          ...
          <div className="pt-8 mt-12 border-t border-warm-gray-200">
